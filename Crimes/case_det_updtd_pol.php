...
<html>
<head>
	<title>Search Case Details</title>
	<link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
	<div class="adv">
		<h1 style="font-size: xx-large; color: beige; font-family:Verdana, Geneva, Tahoma, sans-serif">Search Case Details Updated by the Police Officials</h1>
		<form method="post" action="case_det_pol.php">
